...
export const config = {
  ...
  matcher: [
    '/((?!api/auth|api/onboarding|trust|legal|_next/static|_next/image|logos|icon|favicon|apple-touch-icon|apple-icon|.*\\.(?:svg|png|jpg|jpeg|webp|gif|ico|woff|woff2|ttf|css|js)).*)',
  ],
}
