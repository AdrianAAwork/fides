...
export const assessments = pgTable('assessments', {
  ...
  suggestedOverallBand: varchar('suggested_overall_band', { length: 20 }),
  confirmedOverallBand: varchar('confirmed_overall_band', { length: 20 }),
  confirmedOverallBy: uuid('confirmed_overall_by').references(() => users.id),
  confirmedOverallAt: timestamp('confirmed_overall_at', { withTimezone: true }),
  confirmedOverallNote: text('confirmed_overall_note'),
...
export const assessmentScores = pgTable('assessment_scores', {
  ...
  suggestedBand: varchar('suggested_band', { length: 20 }),
  confirmedBand: varchar('confirmed_band', { length: 20 }),
